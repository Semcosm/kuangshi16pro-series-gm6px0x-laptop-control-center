...
usage() {
  cat <<'EOF'
Usage:
  sudo ./amw0-wkbc-scan.sh [--hold N] SAC1:SA00:SA01:SA02:SA03 [...]

Examples:
  sudo ./amw0-wkbc-scan.sh 0x0000:0x49:0x00:0x1E:0x00
  sudo ./amw0-wkbc-scan.sh --hold 10 0x0000:0x49:0x00:0x1E:0x00 0x0001:0x4c:0x00:0x28:0x00
EOF
}
