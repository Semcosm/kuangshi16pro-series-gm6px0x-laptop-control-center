...
usage() {
  cat <<'EOF'
Usage:
  sudo ./scripts/amw0/amw0-monitor-trace.sh [--interval SEC] [--pre SEC] [--post SEC] wkbc SAC1:SA00:SA01:SA02:SA03
  sudo ./scripts/amw0/amw0-monitor-trace.sh [--interval SEC] [--pre SEC] [--post SEC] scmd CMD

Examples:
  sudo ./scripts/amw0/amw0-monitor-trace.sh wkbc 0x0000:0x49:0x00:0x1E:0x00
  sudo ./scripts/amw0/amw0-monitor-trace.sh wkbc 0x0001:0x4C:0x00:0x28:0x00
  sudo ./scripts/amw0/amw0-monitor-trace.sh scmd 0x87
EOF
}
