...
usage() {
  cat <<'EOF'
Usage:
  sudo ./scripts/amw0/amw0-ec-watch.sh [--interval SEC] [--count N] [--changes-only]

Examples:
  sudo ./scripts/amw0/amw0-ec-watch.sh
  sudo ./scripts/amw0/amw0-ec-watch.sh --changes-only
  sudo ./scripts/amw0/amw0-ec-watch.sh --interval 0.1 --count 300
EOF
}
