...
usage() {
  cat <<'EOF'
Usage:
  sudo ./amw0-wmbc-pack.sh local  SLOT SA00 [SA01 [SA02 [SA03]]]
  sudo ./amw0-wmbc-pack.sh notify SLOT EVENT
  sudo ./amw0-wmbc-pack.sh send   SLOT SAC1 [SA00 [SA01 [SA02 [SA03]]]]
...
Examples:
  sudo ./amw0-wmbc-pack.sh local 0x0 0x49 0x00 0x1E 0x00
  sudo ./amw0-wmbc-pack.sh notify 0x0 0x0001
  sudo ./amw0-wmbc-pack.sh send   0x0 0x0001 0x49 0x00 0x1E 0x00
EOF
}
