...
data_install_path="/usr/share/kuangshi16pro-lcc/data"
capabilities_install_path="/usr/share/kuangshi16pro-lcc/data/capabilities"
fan_tables_install_path="/usr/share/kuangshi16pro-lcc/data/fan-tables"
profiles_install_path="/usr/share/kuangshi16pro-lcc/data/profiles"
...
require_line "$deployment_doc" "\`$data_install_path\`"
require_line "$deployment_doc" "\`$capabilities_install_path\`"
require_line "$deployment_doc" "\`$fan_tables_install_path\`"
require_line "$deployment_doc" "\`$profiles_install_path\`"
